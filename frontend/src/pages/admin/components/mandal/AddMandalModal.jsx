...
const AddMandalModal = ({ isOpen, onClose, editingMandal = null }) => {
  ...
  const [form, setForm] = useState({ name: '', price: '100', mandalType: '', mandalTypeName: '', isActive: true });
    ...
    const timer = setTimeout(() => {
      if (editingMandal) {
        setForm({
          ...
          isActive: editingMandal.isActive ?? true,
        });
      } else {
        setForm({ name: '', price: '100', mandalType: '', mandalTypeName: '', isActive: true });
      }
    }, 0);
