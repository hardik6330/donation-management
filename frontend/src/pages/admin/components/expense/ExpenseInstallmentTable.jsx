...
import { useGetExpenseInstallmentsQuery } from '../../../../services/expenseApi';
import { Loader2, IndianRupee, Calendar, CreditCard } from 'lucide-react';

const ExpenseInstallmentTable = ({ expenseId }) => {
  const { data: installments, isLoading } = useGetExpenseInstallmentsQuery(expenseId);
...
export default ExpenseInstallmentTable;
